...
class Plugin:
    ...
    def pytest_addoption(
        ...
        group: OptionGroup = parser.getgroup("exqudens-extensions")
        group.addoption("--collect-file", action="store", default=False, help="Saves collected test items to json file.")
        group.addoption("--report-file", action="store", default=False, help="Append test events to file in json format.")
        return None
    ...
    def pytest_collection_finish(
        ...
        file: str | None = session.config.getoption("--collect-file")
        if file:
    ...
    def pytest_report_teststatus(
        ...
        file: str | None = config.getoption("--report-file")
        if file:
            entry: dict[str, any] = {
